    ...
    $.getJSON(GSSurl, function (data) {
        ...
        for (var i = 0; i < entry.length; i++) {
            ...
            for (var j = 0; j <= columnNum; j++) {
                ...
                //td.addEventListener("click", function(){clickTdToCheckBox(boxNode.value)}, false);
...
function clickTdToCheckBox(checkBoxValue) {
    $('[value="zero"]');
    $(event.target.id + "")
}
...
function roadAllGrid(columnNum, isFirst) {
    ...
    if (isFirst == true) {
        ...
        $("#tabBody div[name='tabBodyChild']").append($('<ul/>', { class: 'inputUl' }));
        $("#tabBody div[name='tabBodyChild'] ul").append($('<li/>', { id: 'text', class: 'text' }));
        $("#tabBody div[name='tabBodyChild'] ul").append($('<li/>', { id: 'button', class: 'button' }));
        $("#tabBody div[name='tabBodyChild'] ul").append($('<li/>', { id: 'display', class: 'display' }));

        $("#tabBody div[name='tabBodyChild']").append($('<br/>'));
        $("#tabBody div[name='tabBodyChild']").append($('<hr/>', { class : 'hr' }));
        //$("#tabBody div[name='tabBodyChild']").append($('<br/>'));
